class HQMenu {
    ...
    class TestButton1 : ButtonControl {
        y = 0.55
        text = "Rifle";
        action = "_nigg = execVM ""supports\manrecruit.sqf"";";
    };
   
    class TestButton2 : ButtonControl {
        y = 0.45;
        text = "AT";
        action = "_nigg = execVM ""supports\atrecruit.sqf"";";
    };
    ...
    class TestButton3 : ButtonControl {
        ...
        x = 0.69;
        text = "AA";
        action = "_nigg = execVM ""supports\aarecruit.sqf"";";
    };
    ...
    class TestButton5 : ButtonControl {
        ...
        x = 0.5;
        text = "Tank";
        action = "_nigg = execVM ""supports\tankrecruit.sqf"";";
    };
    ...
    class TestButton6 : ButtonControl {
        ...
        x = 0.69;
        text = "APC";
        action = "_nigg = execVM ""supports\apcrecruit.sqf"";";
    };
    ...
    class TestButton7 : ButtonControl {
        ...
        x = 0.37;
        text = "Jet";
        action = "_nigg = execVM ""supports\jetrecruit.sqf"";";
    };
    ...
    class TestButton8 : ButtonControl {
        ...
        x = 0.37;
        text = "Heli";
        action = "_nigg = execVM ""supports\helirecruit.sqf"";";
    };
    ...
    class TestButton9 : ButtonControl {
        ...
        x = 0.21;
        text = "AHeli";
        action = "_nigg = execVM ""supports\attackheli.sqf"";";
    };
    ...
    class TestButton10 : ButtonControl {
        ...
        x = 0.21;
        text = "Car";
        action = "_nigg = execVM ""supports\carrecruit.sqf"";";
    };
